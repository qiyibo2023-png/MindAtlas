...
http.createServer((req,res)=>{
 ...
 const fixtures={'/shared.js':'differential-fixtures.js','/cases.js':'trauma-fixtures.js','/fixture.js':'trauma-browser.js'};
 ...
 if(pathname==='/'){res.setHeader('Content-Type','text/html;charset=utf-8');res.end(fs.readFileSync(path.join(root,'index.html'),'utf8').replace('</body>','<script src="/cases.js"></script><script src="/shared.js"></script><script src="/fixture.js"></script></body>'));return;}
...
}).listen(4177,'127.0.0.1',()=>console.log('Synthetic trauma harness: http://127.0.0.1:4177/'));
