...
G.contextCoverageMetadata=Object.freeze({version:'contextual-safety-coverage-v1.0.0',reviewStatus:'unreviewed',signals:['medical.severeConfusion','medical.severeBreathingDifficulty','harmToOthers.intent'],thresholdChanges:false});
...
if(/^\s*\u6211(?:\u73b0\u5728)?\u6253\u7b97\u4f24\u5bb3(?:\u522b\u4eba|\u4ed6\u4eba)/.test(c.text))G.put(e.signals,'harmToOthers.intent',true);
}return e;};
